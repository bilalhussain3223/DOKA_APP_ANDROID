...
fun ExposureTimerSettingsScreen(
    ...
    LaunchedEffect(sharedVM.timeForExposure.floatValue) {
        viewModel.timer.floatValue = sharedVM.timeForExposure.floatValue
    }
    ...
    Column(
        ...
        Row(
            ...
            Image(
                ...
                modifier = Modifier
                    .clickable {
                        sharedVM.timeForExposure.floatValue = viewModel.timer.floatValue
                        navigateNext()
                    }
            )
        }
...
fun TimeSlider(modifier: Modifier = Modifier, viewModel: ExposureTimerViewModel = hiltViewModel()) {
    ...
    Row(
        ...
        Image(
            modifier = Modifier.clickable {
                if (viewModel.timer.floatValue <= 119)
                    viewModel.timer.floatValue += 1
            },
